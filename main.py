"""Scrape Aviat listings from Barnstormers.com and render them
into docs/index.html for embedding via <iframe> on taildraggers.com.
"""
...
PAGE_TITLE = "Other Aviat Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    ("Trade-A-Plane", "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=aviat&s-original-search=aviat"),
    ("Controller", "https://www.controller.com/listings?keywords=aviat"),
    ("ASO", "https://aso.com/search?q=Aviat"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More Aviat Listings</h2>
    <p>View additional Aviat Aircraft listings at these fine sites:</p>
